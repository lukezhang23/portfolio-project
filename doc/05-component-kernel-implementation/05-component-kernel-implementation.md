...
I will make the scorecard an array because my scorecard will be a fixed amount of holes so it does not require a more robust data structure. Additionally I want to use this component since it is not a modified OSU component so it is more applicable to the real world. However, I already have experience with arrays which should make this easy to implement.
